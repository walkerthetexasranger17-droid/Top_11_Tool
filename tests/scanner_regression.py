...
if "const MODEL='gemini-3.8-flash'" not in scanner: errs.append('Gemini 3.8 Flash model marker missing')
...
if errs:
    ...
    sys.exit(1)
print('PASS Scanner v3 offline contract: direct Gemini free-tier path, 20 playstyles x 4 levels, 19 special abilities, David Andrews multi-SA fixture (15 skills + 2 abilities)')
