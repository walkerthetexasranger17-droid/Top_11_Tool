...
errs=[]
required=[
 'const VERSION=5', 'gemini-3.1-flash-live-preview', "thinkingLevel:'HIGH'",
...
if errs:
    print('FAIL Scanner v5 Live contract')
    [print(' -',e) for e in errs]
    raise SystemExit(1)
print('PASS Scanner v5 Live contract: HIGH-thinking Live pipeline + four visual indexes + no benchmark answers')
