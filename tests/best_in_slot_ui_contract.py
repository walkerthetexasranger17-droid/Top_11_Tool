...
ck('./js/best-in-slot-data.js?r=0629' in html,'Best-in-Slot data script not loaded')
ck('./js/best-in-slot-engine.js?r=0629' in html,'Best-in-Slot engine script not loaded')
ck(html.index('best-in-slot-data.js')<html.index('best-in-slot-engine.js')<html.index('app.js?r=0629'),'Best-in-Slot load order is wrong')
