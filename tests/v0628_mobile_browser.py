...
if errs:
    print('FAIL v0.6.28 mobile header-art browser contract')
    for e in errs: print('-',e)
    raise SystemExit(1)
print('PASS v0.6.28 mobile browser: topbar and all approved page headers render inside the phone viewport')
