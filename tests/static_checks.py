...
if 'v0.5.6' not in html: errs.append('visible version is not v0.5.6')
...
if "const CACHE='te-v0-5-6" not in sw_text or "e.request.mode==='navigate'" not in sw_text or "cache:'no-store'" not in sw_text: errs.append('v0.4.12 service-worker update/navigation freshness guard missing')
