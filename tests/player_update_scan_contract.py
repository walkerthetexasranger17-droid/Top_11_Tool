...
need("scope:'age-skills-only-auto-name-match'" in app,'automatic save records narrow mutation provenance')
need("{...target,age:Number(scan.age),skills:{...scan.skills}" in app,'automatic update mutates saved age + skills only')
...
need("updateScanSafeForAutoSave" in app,'automatic save requires clean scanner verification')
