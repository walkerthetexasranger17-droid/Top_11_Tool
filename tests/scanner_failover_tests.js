...
ok(/submit_playstyle_level/.test(src)&&/submit_playstyle_overlay/.test(src),'split exact playstyle level/overlay passes');
...
console.log(`PASS scanner v12 Live contract: ${n} assertions`);
