...
with sync_playwright() as pw:
    ...
    title=page.locator('#page-squad .v0624-page-title h1').inner_text().strip().replace('\n',' ')
...
if errs:
    print('FAIL v0.6.24 mobile hero browser contract')
    for e in errs: print('-',e)
    raise SystemExit(1)
print('PASS v0.6.24 browser: compact aligned hero rhythm, full fixed backgrounds, no Home copy, functional Squad title, no hero seam')
