(() => {
  ...
  const MODEL_VERSION='30527-role-v1',FORMATIONS=B.FORMATION_TEMPLATES.map((f,i)=>({...f,templateOrder:i}));
  ...
  TE.Formation={MODEL_VERSION,FORMATIONS,options,suitability,roleStats,roleMean,candidate,assign,choose,applyCoordinates,compareFormation};
})();
