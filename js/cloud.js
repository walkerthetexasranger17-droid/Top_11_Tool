(() => {
  ...
  async function initFirebase(){
    ...
    try{
      ...
      console.info('[Top Eleven Tool] Cloud sync ready',{runtime:'0.6.23',source:state.lastSyncSource,records:state.syncCount,pending:state.pendingWrites,localFirst:localReady});
      return true;
