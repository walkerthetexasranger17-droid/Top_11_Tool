(() => {
  ...
  async function initFirebase(){
    ...
    try{
      ...
      console.info('[Top Eleven Tool] Cloud sync ready',{runtime:'0.6.44',source:state.lastSyncSource,records:state.syncCount,pending:state.pendingWrites,localFirst:localReady});
      return true;
