# Top Eleven Tool v5.2.23 — Build 30527 Release Report
...
## v5.2.23 native screenshot compatibility
...
- Service-worker cache bumped to `te-v5-2-23-30527` so phones do not retain the previous scanner bundle.
