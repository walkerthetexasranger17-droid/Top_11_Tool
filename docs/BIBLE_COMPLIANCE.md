# v5.2.11 Bible Compliance Record — Build 30527
...
| Area | v5.2.11 implementation | Status |
| --- | --- | --- |
...
| Squad / Profile / Scanner | Squad supports search plus role, age, OVR, playstyle and availability filters. Profile shows role/white-skill and playstyle state information. Scanner v3 uses the Gemini Developer API free-tier ingestion path; player schema/role/playstyle/special-ability compatibility is preserved. | PASS |
...
| PWA / precache | Existing theme/assets/icon/PWA behaviour retained. Service-worker cache `te-v5-2-11-30527` precaches every required runtime module/data/asset: 70/70. | PASS |
...
- `tests/core-tests.js`: PASS — 249 assertions.
- `tests/scanner_regression.py`: PASS — direct Gemini free-tier contract, 20 playstyles × 4 levels, 19 special abilities, and the David Andrews two-ability acceptance fixture.
