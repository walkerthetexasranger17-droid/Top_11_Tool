...
The Scanner v2 verification row below is retained as historical provenance for the superseded v5.2.8 engine. v5.2.18 does not execute that engine; Scanner v3 is documented in `SCANNER_V3_GEMINI_FREE.md`.
